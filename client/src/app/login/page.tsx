...
export default function LoginPage() {
  ...
  return (
    <StyledWrapper>
      <form className="form" onSubmit={isForgotPassword ? handleForgotPassword : handleSubmit}>
        ...
        {message && (
          <div style={{ color: "green", fontSize: "14px", textAlign: "center" }}>{message}</div>
        )}
        ...
        {!isForgotPassword && (
          <div className="flex-row">
            ...
            <span className="span" onClick={() => setIsForgotPassword(true)}>Forgot password?</span>
          </div>
        )}
        ...
        {!isForgotPassword ? (
          <>
            <p className="p">
              ...
              <a href="/signup" className="span">Sign Up</a>
            </p>
            ...
            <div className="flex-row">
              ...
              <button className="btn apple" type="button">
                <svg version="1.1" height={20} width={20} id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 22.773 22.773" enableBackground="new 0 0 22.773 22.773" xmlSpace="preserve">
                  <g>
                    <g>
          ...
          <p className="p">
            <span className="span" onClick={() => setIsForgotPassword(false)}>Back to Login</span>
          </p>
        )}
      </form>
    </StyledWrapper>
