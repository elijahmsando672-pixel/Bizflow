    ...
    <header className="flex h-16 items-center justify-between border-b border-border bg-background/80 px-4 lg:px-6 backdrop-blur-xl">
      <div className="flex flex-1 items-center gap-3">
        ...
        <div className="relative w-full max-w-xs lg:max-w-sm">
          ...
          <Input
            ...
            className="h-9 border-input bg-muted/50 pl-10 text-sm placeholder:text-muted-foreground focus:border-primary/30 focus:ring-primary/20"
          />
        </div>
      </div>
      <div className="flex items-center gap-1.5 lg:gap-2">
        <div className="relative" ref={dropdownRef}>
          <Button
            size="sm"
            className="gap-1.5 bg-primary text-primary-foreground shadow-sm hover:opacity-90 hidden sm:inline-flex"
            ...
            <div className="absolute right-0 top-full mt-2 w-48 overflow-hidden rounded-xl border border-border bg-card/90 backdrop-blur-xl shadow-dropdown z-50">
              ...
              <div className="p-1">
                {actions.map((action) => (
                  <button
                    key={action.href}
                    className="flex w-full items-center gap-2.5 rounded-lg px-3 py-2 text-sm text-foreground/80 hover:bg-muted transition-colors duration-150"
                    onClick={() => {
                      setOpen(false);
        ...
        <div className="ml-1 lg:ml-2 flex items-center gap-2 lg:gap-3 border-l border-border pl-2 lg:pl-3">
